...
static bbf_get_sys_nsp_oid_hook_type prev_bbf_get_sys_nsp_oid_hook = NULL;
...
InstallExtendedHooks(void)
{
	...
	bbf_get_sys_nsp_oid_hook = get_sys_nsp_oid;
...
UninstallExtendedHooks(void)
{
	...
	bbf_get_sys_nsp_oid_hook = prev_bbf_get_sys_nsp_oid_hook;
